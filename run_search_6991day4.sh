...
# Search 6991_day4_with_selection for ONE specific 278 bp circle, using
...
INPUT_FILE="6991_day4_with_selection"
OUT_BASE="6991_day4_278bp"        # output files derive from this name
